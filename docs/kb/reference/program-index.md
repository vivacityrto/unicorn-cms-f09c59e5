...
| Tenant Operating Model | P1.2-c static closure, aggregate legacy-profile classification, and all-source retention-gap sweep complete; `unicorn-qa`-only target, disable-first action shape, supervised timing, Carl-owned rollback baseline, and 60-minute observation window approved for the planning packet, while production and execution/retirement authority remain gated | `codex/tom-p1-2c-ops-approval-observation-20260915` | Codex | 2026-09-15 |
