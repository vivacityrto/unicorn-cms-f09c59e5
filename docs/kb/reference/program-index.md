...
| RBAC v6 | planning | All 15 §13 items dispositioned (item 1 permanently decided 2026-09-11 via ADR-030; items 2-13 baselined 2026-09-10; items 14/15 parked). Packet P0.1 complete 2026-09-11 — both [P0.1-a (static)](rbac-v6/p0/p0-1-a-static-inventory.md) and [P0.1-b (live DB)](rbac-v6/p0/p0-1-b-live-inventory.md) delivered; confirmed the plan's 85 features/523 role rows figures exactly. Packet P1's mechanical export ([P1-a](rbac-v6/p1/p1-a-review-worksheet.md)), discussion-draft classification ([P1-b](rbac-v6/p1/p1-b-draft-classification.md)), [P1-d static enforcement ledger](rbac-v6/p1/p1-d-static-enforcement-ledger.md), [P1-e bundled-verb decomposition](rbac-v6/p1/p1-e-bundled-verb-decomposition.md), [P1-f client-details semantics](rbac-v6/p1/p1-f-client-details-capability-semantics.md), [P1-g staff-internal consumer inventory](rbac-v6/p1/p1-g-staff-internal-consumer-inventory.md), [P1-h high-risk delegability controls](rbac-v6/p1/p1-h-high-risk-delegability-control-worksheet.md), [P1-i job-role defaults/AJ/CSC pilot](rbac-v6/p1/p1-i-job-role-defaults-aj-csc-pilot.md), [P1-j AJ/CSC shadow evidence](rbac-v6/p1/p1-j-aj-csc-shadow-evidence.md), [P1-k source-boundary preparation](rbac-v6/p1/p1-k-aj-csc-source-boundary-preparation.md), and [P1-l golden-matrix review draft](rbac-v6/p1/p1-l-aj-csc-golden-matrix-review-draft.md) are delivered as preparation; the [remaining gated approval packet](codebase-optimization/cross-cutting/remaining-gated-approval-packets-2026-09-12.md) names the exact product/security asks before any golden row becomes policy or implementation sequencing starts. No production migration, Edge deployment, permission grant, or role change authorized yet. | [`rbac-v6-authorization-implementation-plan-2026-09-01.md`](rbac-v6-authorization-implementation-plan-2026-09-01.md) |
| Tenant Operating Model | planning | All 13 §18 decisions closed (items 2-13 on 2026-09-10 via ADR-017 through ADR-028; item 1 on 2026-09-11 via ADR-030). P0.1 evidence gathering and the seven owner-disposition directions are recorded as complete in the [source inventory](../codebase-state/tenant-p0-source-inventory.md) and [owner-disposition register](tenant-operating-model/p0/p0-1-owner-disposition-register.md); implementation remains separately gated. **T1 P0.2/P0.3 preparation was approved 2026-09-12, and expanded protected characterization completed in allowlisted `unicorn-qa` on 2026-09-13 (run 34742523972): anonymous plus six authenticated personas, 48 passed and 4 intentional client-only skips, with route timings and selected QA-only query-plan evidence recorded.** The remaining P0.2/P0.3 work is baseline cutoff, full request-waterfall evidence, integrator/team-leader/disabled-staff/service-principal dispositions, and cross-initiative owner review. [P1.3](tenant-operating-model/p1/p1-3-legacy-client-role-retirement-plan.md) records the approved plan to retire legacy Client Parent/Child labels after explicit relationship/capability parity. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
| Client Health Activity Analytics | planning (architecturally a child of Tenant Operating Model — see Dependencies below) | P3-A and H0.1-a/b/c delivered. **H1 unknown-state consumer containment delivered 2026-09-13** across retention overview, team-capacity burn, dashboard triage, Ask Viv portfolio facts, and Ask Viv `compare_clients`; missing/failed sources now surface as `unavailable` without live source/schema/cron changes. H0.3b/c read-only forecast-job/source evidence and owner disposition delivered 2026-09-13: retain-but-not-restart/repair, keep consumers unavailable, and retain legacy artifacts as evidence. Replacement-shadow, freshness/quality, and consultant-data gates remain open. | [`client-health-activity-analytics-plan-2026-09-03.md`](client-health-activity-analytics-plan-2026-09-03.md) |
...
| RBAC v6 | §13 fully dispositioned; Packet P0.1 (a+b), P1-a, P1-b, P1-d, P1-e, P1-f, P1-g staff-internal consumer inventory, P1-h high-risk control worksheet, P1-i seat/pilot worksheet, P1-j shadow evidence contract, P1-k source-boundary preparation, and P1-l golden-matrix review draft delivered; policy rows, role defaults, shadow telemetry, and pilot enrollment remain review-gated | codex/rbac-r2f-shadow-evidence | Codex | 2026-09-13 |
| Tenant Operating Model | §18 items 1-13 all closed; P0.1 evidence and owner-disposition directions complete 2026-09-12, with implementation gates preserved; expanded protected P0.2/P0.3 characterization completed 2026-09-13, with residual evidence and owner-review gates open | codex/approval-next-goal | Codex | 2026-09-05 (P0.1 start) / 2026-09-12 (P0.1 disposition + P0.2/P0.3 prep) |
| Client Health Activity Analytics | P3-A consumer containment closed 2026-09-08; H0.1-a/b/c delivered 2026-09-11/12; H1 consumer containment delivered 2026-09-13; H0.3b/c evidence and owner disposition delivered 2026-09-13; jobs remain stopped, consumers unavailable, and replacement-shadow work separately gated | — | Claude Code / Codex | 2026-09-11/12 |
...
- **TOM P0.2/P0.3 preparation approved 2026-09-12:** the synthetic,
  ...
  on 2026-09-13, and expanded protected characterization completed in GitHub
  Actions run `34742523972` (anonymous plus six authenticated personas; 48
  passed, 4 intentional client-only skips). Route timings and selected QA-only
  query-plan evidence are recorded; baseline cutoff, full request-waterfall
  evidence, integrator/team-leader/disabled-staff/service-principal
  dispositions, and cross-initiative owner review remain open. **Client Health H1 semantics approved 2026-09-12:** missing or stale
