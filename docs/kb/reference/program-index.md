...
| Tenant Operating Model | planning | All 13 §18 decisions are closed. P0.1/P0.2/P0.3 evidence and owner dispositions are complete. P1.1 contact-promotion canary evidence passed, and the first [P1.2-b guarded ghost-contact QA snapshot](tenant-operating-model/p1/p1-2-b-ghost-contact-dry-run-execution-packet.md) completed on 2026-09-15 with redacted output, zero writes, and no holdouts; contact insertion, ghost retirement, and production/runtime work remain separately gated. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
...
| Tenant Operating Model | P1.2-b first guarded hosted-QA snapshot passed with redacted evidence; apply/retirement and production/runtime work remain separately gated | `codex/tom-p1-2-qa-docs-20260915` | Codex | 2026-09-15 |
