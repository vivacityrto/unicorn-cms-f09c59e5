...
| Tenant Operating Model | Repository source/configuration retirement is committed in `b771e3f7e`; hosted deletion and immediate read-only verification remain pending, with the 60-minute observation waived | `codex/tom-p1-2c-retirement-docs-20260916` | Codex | 2026-09-16 |
...
- [2026-09-16 — TOM P1.2-c observation aborted by in-window redeployment](../../audit-log/entries/2026-09-16-tom-p12c-observation-aborted-redeploy.md) — final read-only check found inventory back at 193 and `activate-ghost-user` present/ACTIVE again after an in-window redeployment; exact-window request logs and audit events remained zero, but retirement closeout is blocked pending redeployment-source reconciliation and a fresh decision.
