...
| Tenant Operating Model | P1.2-c production deletion executed after explicit action-time approval; final 60-minute read-only observation and documentation/audit closure are pending | `codex/tom-p1-2c-retirement-docs-20260916` | Codex | 2026-09-16 |
...
- [2026-09-16 — TOM P1.2-c production `activate-ghost-user` deletion and observation](../../audit-log/entries/2026-09-16-tom-p12c-production-deletion-and-observation.md) — explicit action-time approval authorized deletion from production after read-only preflight; inventory fell 193→192, exact lookup is absent, guards and reset path remain deployed, activation-job open/locked/unprocessed counts are zero, and the final 60-minute read-only observation is pending.
