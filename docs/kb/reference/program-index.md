...
| Tenant Operating Model | planning | All 13 §18 decisions are closed. P0.1 evidence and owner dispositions are complete; the expanded P0.2/P0.3 characterization, QA query-family preparation, negative-case/cleanup runbook, and cross-initiative review are recorded. The first [P1.1 contact-promotion packet](tenant-operating-model/p1/p1-1-first-contact-promotion-implementation-packet.md) is drafted for review; runtime implementation, migration, ledger cutover, Realtime changes, and ghost retirement remain separately gated. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
...
|---|---|---|---|---|
| Codebase Optimization | Phase 4 closed 2026-09-11; no current implementation packet | — | Claude Code / Codex | 2026-09-14 |
| RBAC v6 | P0.1 and P1 preparation delivered; policy rows, role defaults, shadow telemetry, and pilot enrollment remain review-gated | — | Codex | 2026-09-14 |
| Tenant Operating Model | P0 evidence/preparation delivered; P1.1 contact-promotion packet drafted for review; runtime work remains separately gated | — | Codex | 2026-09-14 |
| Client Health Activity Analytics | H0 characterization/containment and consultant evidence preparation delivered; consultant operational data and replacement-shadow gates remain open | — | Claude Code / Codex | 2026-09-14 |
