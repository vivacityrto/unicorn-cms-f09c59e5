...
| Tenant Operating Model | P1.2-c static closure merged; read-only job/account census complete; explicit disposition, historical log evidence, security review, and retirement authority remain gated | `codex/tom-p1-2c-census-20260915` | Codex | 2026-09-15 |
