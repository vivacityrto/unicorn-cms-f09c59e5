...
| Tenant Operating Model | planning | All 13 §18 decisions closed (items 2-13 on 2026-09-10 via ADR-017 through ADR-028; item 1 on 2026-09-11 via ADR-030). P0.1 evidence gathering and the seven owner-disposition directions are recorded as complete in the [source inventory](../codebase-state/tenant-p0-source-inventory.md) and [owner-disposition register](tenant-operating-model/p0/p0-1-owner-disposition-register.md); implementation remains separately gated. **T1 P0.2/P0.3 preparation was approved 2026-09-12;** the offline [fixture manifest](tenant-operating-model/p0/p0-2-p0-3-offline-qa-fixture-manifest.md) is prepared, while hosted execution remains blocked on QA credential/operator/artifact gates. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
| Client Health Activity Analytics | planning (architecturally a child of Tenant Operating Model — see Dependencies below) | P3-A and H0.1-a/b/c delivered. **H1 unknown-state consumer containment delivered 2026-09-13** across retention overview, team-capacity burn, dashboard triage, Ask Viv portfolio facts, and Ask Viv `compare_clients`; missing/failed sources now surface as `unavailable` without live source/schema/cron changes. H0.3b/c read-only forecast-job/source evidence delivered 2026-09-13; recommendation is retain-but-not-restart/repair (mark the current composite contract unavailable), with formal owner disposition or replacement-shadow authorization still open. Freshness/quality and consultant-data gates remain open. | [`client-health-activity-analytics-plan-2026-09-03.md`](client-health-activity-analytics-plan-2026-09-03.md) |
...
| Tenant Operating Model | §18 items 1-13 all closed; P0.1 evidence and owner-disposition directions complete 2026-09-12, with implementation gates preserved; P0.2/P0.3 offline fixture preparation complete and hosted execution blocked on QA credential/operator/artifact gates | codex/approval-next-goal | Codex | 2026-09-05 (P0.1 start) / 2026-09-12 (P0.1 disposition + P0.2/P0.3 prep) |
| Client Health Activity Analytics | P3-A consumer containment closed 2026-09-08; H0.1-a/b/c delivered 2026-09-11/12; H1 consumer containment delivered 2026-09-13; H0.3b/c evidence delivered 2026-09-13 with owner disposition/replacement-shadow decision open; no forecast-job/source repair or restart authorized | — | Claude Code / Codex | 2026-09-11/12 |
...
- **TOM P0.2/P0.3 preparation approved 2026-09-12:** the offline fixture and
  persona manifest is being prepared; hosted execution remains blocked on a
  QA-only credential, named operator, fixture approval, and private artifact
  owner. **Client Health H1 semantics approved 2026-09-12:** missing or stale
  burn/retention inputs are to remain `unavailable`/unknown; the five named
  consumer-containment slices are delivered. H0.3b/c evidence recommends
  retaining the current composite jobs without restart/repair; owner
  disposition, freshness/quality, and consultant-data gates remain open.
