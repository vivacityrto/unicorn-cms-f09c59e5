...
| Tenant Operating Model | P1.2-c static closure, aggregate legacy-profile classification, and all-source retention-gap sweep complete; `unicorn-qa`-only target, disable-first action shape, supervised timing, and Carl-owned rollback baseline reconciled for the planning packet, while observation window, production, and execution/retirement authority remain gated | `codex/tom-p1-2c-ops-approval-rollback-owner-20260915` | Codex | 2026-09-15 |
