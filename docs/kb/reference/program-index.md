...
| Tenant Operating Model | P1.2-c static closure, aggregate legacy-profile classification, and all-source retention-gap sweep complete; individual disposition, request-level reconstruction, and retirement authority remain gated | `codex/tom-p1-2c-evidence-reconcile-20260915` | Codex | 2026-09-15 |
