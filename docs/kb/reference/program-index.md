...
| RBAC v6 | §13 fully dispositioned; Packet P0.1 (a+b), P1-a, P1-b, P1-d, P1-e, and P1-f client-details semantics delivered; server-boundary reconciliation and golden-matrix policy rows remain review-gated | codex/rbac-r2b-client-details | Codex | 2026-09-12 |
