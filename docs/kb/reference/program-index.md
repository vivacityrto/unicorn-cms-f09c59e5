...
| Tenant Operating Model | P1.2-c deletion was initially observed, but the final 60-minute check found an in-window redeployment; retirement closeout is blocked pending source reconciliation and a fresh decision | `codex/tom-p1-2c-retirement-docs-20260916` | Codex | 2026-09-16 |
