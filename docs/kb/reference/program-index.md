...
| Tenant Operating Model | planning | All 13 §18 decisions closed (items 2-13 on 2026-09-10 via ADR-017 through ADR-028; item 1 on 2026-09-11 via ADR-030). P0.1 evidence gathering and the seven owner-disposition directions are recorded as complete in the [source inventory](../codebase-state/tenant-p0-source-inventory.md) and [owner-disposition register](tenant-operating-model/p0/p0-1-owner-disposition-register.md); implementation remains separately gated. **T1 P0.2/P0.3 preparation was approved 2026-09-12; the expanded protected characterization now covers nine browser personas plus a non-browser service-principal read contract, and the versioned production metadata capture establishes migration cutoff `20260911094544` at `origin/main@29224ccb`.** The remaining P0.2/P0.3 work is broader query-family/cardinality coverage and cross-initiative owner review. [P1.3](tenant-operating-model/p1/p1-3-legacy-client-role-retirement-plan.md) records the approved plan to retire legacy Client Parent/Child labels after explicit relationship/capability parity. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
