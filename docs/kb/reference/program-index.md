...
| Tenant Operating Model | P1.2-c static closure, aggregate legacy-profile classification, and all-source retention-gap sweep complete; `unicorn-qa`-only target approved for the planning packet, while action shape, timing, rollback owner, observation window, production, and retirement authority remain gated | `codex/tom-p1-2c-ops-approval-qa-20260915` | Codex | 2026-09-15 |
