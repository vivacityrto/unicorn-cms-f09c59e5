...
| Tenant Operating Model | planning | All 13 §18 decisions are closed. P0.1/P0.2/P0.3 evidence and owner dispositions are complete. P1.1 contact-promotion canary evidence passed. P1.2-b's guarded ghost-contact snapshot and P1.2-d's approved one-row `unicorn-qa` apply canary both passed with redacted evidence, zero out-of-scope writes, and no holdouts; 14 candidate rows remain untouched and separately gated, as do ghost retirement and production/runtime work. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
...
| Tenant Operating Model | P1.2-b evidence and P1.2-d one-row QA canary passed; 14 remaining candidate rows, retirement, and production/runtime work remain separately gated | `codex/tom-p1-2-qa-apply-20260915` | Codex | 2026-09-15 |
