...
| Tenant Operating Model | planning | All 13 §18 decisions closed (items 2-13 on 2026-09-10 via ADR-017 through ADR-028; item 1 on 2026-09-11 via ADR-030). **Correction 2026-09-11:** this row previously said P0/P1 scoping "not yet started or authorized" — stale; the plan's own §7 packet table already shows P0.1 (tenant operating-model inventory) **in progress since 2026-09-05** (PR #647, [`tenant-p0-source-inventory.md`](../codebase-state/tenant-p0-source-inventory.md)), read-only/behavior-preserving discovery explicitly pre-authorized by the plan itself (§1: "tenant P0 evidence collection does not need to wait for RBAC because it is read-only and behavior-preserving"). Carl authorized Codex to continue/expand P0.1 2026-09-11, folding in the `ManageTenants.tsx` field/source-of-truth matrix, identity ledger, and view/RPC/write graph the Phase 4 exit re-audit surfaced. The current inventory records merged #1185 and the 2026-09-12 read-only post-remediation grant/guard verification; the [owner-disposition register](tenant-operating-model/p0/p0-1-owner-disposition-register.md) now makes the remaining P0.1 decisions explicit. **T1 P0.2/P0.3 preparation was approved 2026-09-12;** the offline [fixture manifest](tenant-operating-model/p0/p0-2-p0-3-offline-qa-fixture-manifest.md) is being prepared, while hosted execution remains blocked on QA credential/operator/artifact gates. | [`tenant-operating-model-data-architecture-plan-2026-09-02.md`](tenant-operating-model-data-architecture-plan-2026-09-02.md) |
| Client Health Activity Analytics | planning (architecturally a child of Tenant Operating Model — see Dependencies below) | Current implementation reconciliation (2026-09-08): P3-A has contained the legacy stage-health signal on the main dashboard, executive widget, triage views, and Ask Viv hotspot tool. **H0.1-a** ([notes & tasks](client-health-activity-analytics/h0/h0-1-a-notes-and-tasks-characterization.md)), **H0.1-b** ([dashboard query family](client-health-activity-analytics/h0/h0-1-b-dashboard-query-family-characterization.md)), and **H0.1-c** ([synthetic fixtures](client-health-activity-analytics/h0/h0-1-c-dashboard-query-synthetic-fixture-scope.md)) delivered 2026-09-11/12. **H1 decision approved 2026-09-12:** empty, failed, stale, or invalid burn/retention sources should present as `unavailable`/unknown rather than `normal`/`stable`; implementation and forecast-job disposition remain separately gated. July dashboard-health history is explicitly marked superseded. | [`client-health-activity-analytics-plan-2026-09-03.md`](client-health-activity-analytics-plan-2026-09-03.md) |
...
| Tenant Operating Model | §18 items 1-13 all closed; P0.1 in progress since 2026-09-05 (PR #647), with source/identity/security evidence attached, post-#1185 grants/guards verified read-only on 2026-09-12, owner dispositions remaining, and P0.2/P0.3 offline fixture preparation underway | codex/approval-next-goal | Codex | 2026-09-05 (P0.1 start) / 2026-09-12 (P0.2/P0.3 plan approval) |
| Client Health Activity Analytics | P3-A consumer containment closed 2026-09-08; H0.1-a/b/c delivered 2026-09-11/12; H1 unavailable/unknown semantics approved 2026-09-12, with implementation and forecast-job disposition still gated | — | Claude Code / Codex | 2026-09-11/12 |
...
- **TOM P0.2/P0.3 preparation approved 2026-09-12:** the offline fixture and
  ...
  burn/retention inputs are to remain `unavailable`/unknown; implementation
  and forecast-job disposition remain separately gated.
