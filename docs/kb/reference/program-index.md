...
| RBAC v6 | §13 fully dispositioned; Packet P0.1 (a+b), P1-a, P1-b, and P1-d static ledger delivered/preparing; server-boundary reconciliation and golden-matrix policy rows remain review-gated | codex/approval-next-goal | Codex | 2026-09-12 |
