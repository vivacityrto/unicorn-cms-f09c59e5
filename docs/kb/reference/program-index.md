...
| RBAC v6 | §13 fully dispositioned; Packet P0.1 (a+b), P1-a, P1-b, P1-d, and P1-e bundled-verb decomposition delivered; server-boundary reconciliation and golden-matrix policy rows remain review-gated | codex/rbac-r2a-bundled-verbs | Codex | 2026-09-12 |
