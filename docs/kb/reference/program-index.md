...
| Tenant Operating Model | P1.2-c evidence and approval gates are documented, but final supervised preflight aborted: the authoritative `unicorn-qa` project currently lacks `activate-ghost-user`, while another connector exposed the historical target in a different project; target identity must be reconciled before any action | `codex/tom-p1-2c-qa-target-preflight-abort-20260915` | Codex | 2026-09-15 |
