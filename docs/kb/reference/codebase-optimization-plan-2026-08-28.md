...
| Phase 2.5 any-batch 2+ | Retire remaining `any` (3,713) in bounded batches — `src/hooks` (1,195) is the heaviest single directory and may need splitting into 2–3 batches itself; `qc.ts` cluster (deferred above) is a good next small batch | ⏳ Not started | — | — |
