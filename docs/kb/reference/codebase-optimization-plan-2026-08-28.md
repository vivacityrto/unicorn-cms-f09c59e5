...
| Phase 2.5 PR N+ | Retire `any` (3,737, the large majority of the baseline) in bounded batches ordered by directory weight — `src/hooks` (1,195) is the heaviest single directory and may need splitting into 2–3 batches itself | ⏳ Not started | — | — |
