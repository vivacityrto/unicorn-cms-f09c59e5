...
| Phase 2.5 any-batch 9b+ | Continue `src/components/client` (293 findings remaining, 17 files, largest: `ClientMessagesTab.tsx` 28, `ClientIntegrationsTab.tsx` 31, `RenewalConfirmDialog.tsx` 24, `AddTimeDialog.tsx` 19, `PackageDataManager.tsx` 18, `StartPackageDialog.tsx` 16, `TenantUsersTab.tsx` 14, `EditTimeDialog.tsx` 12, `ClientPackagesTab.tsx` 11, `PackageStagesManager.tsx` 10, `ClientStructuredNotesTab.tsx` 10, plus 6 files 5-6 each, then `ClientTimeTab.tsx` 71 — the single largest file in the cluster) | ⏳ Not started | — | — |
