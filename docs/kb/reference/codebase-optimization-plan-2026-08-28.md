...
> **Phase 2.5 package-usage read checkpoint (2026-09-06, PR pending):** `usePackageUsageQuery.tsx` narrowed four explicit-any findings in the read-oriented package-instance mapping. Threshold/dismissal RPCs remain unchanged and uninvoked. Baseline is 830 explicit-any / 837 total errors / 39 warnings across 192 files; authenticated browser verification is pending.
