...
| Phase 2.5 any-batch 3+ | Retire remaining `any` (3,711) in bounded batches — `src/hooks` (1,195) is the heaviest single directory and may need splitting into 2–3 batches itself | ⏳ Not started | — | — |
