...
> **Phase 2.5 document-stage links checkpoint (2026-09-06, PR pending):** `DocumentAdditionalStagesField.tsx` removed four explicit-any casts with typed stage-link rows. Immediate add/remove writes were not invoked by browser verification; baseline is 821 explicit-any / 828 total errors / 39 warnings across 190 files.
