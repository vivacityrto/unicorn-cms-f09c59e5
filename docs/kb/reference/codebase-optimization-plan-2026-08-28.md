...
> **Phase 2.5 note-form lookup checkpoint (2026-09-06, PR pending):** `NoteFormDialog.tsx` removed four explicit-any lookup casts while preserving its write/title-extraction paths. Baseline is 799 explicit-any / 806 total errors / 39 warnings across 185 files; authenticated browser verification is pending.
