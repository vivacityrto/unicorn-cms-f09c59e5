...
| Phase 2.5 any-batch 9d | `ClientTimeTab.tsx` (71 findings) — the single largest file remaining in `src/components/client`; closes out the cluster entirely once done. Cross-check against the Phase 2.6 register (now checked in-repo, not just on `origin/main`) before starting. | ⏳ Not started | — | — |

### Phase 2.6 — verified retirement and bounded consolidation (council-planned 2026-09-04)

The three-seat council investigation is complete and recorded in [`dead-code-feature-consolidation-investigation-2026-09-04.md`](dead-code-feature-consolidation-investigation-2026-09-04.md). No retirement or consolidation implementation PR has started. The first implementation action is to regenerate the import graph and route/metrics evidence from that PR's fresh branch-cut SHA; the candidate register is not itself deletion authority.
