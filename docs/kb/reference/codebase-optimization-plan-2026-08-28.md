...
> **Phase 2.5 document-request hook checkpoint (2026-09-06, PR pending):** `useDocumentRequests.tsx` narrowed five explicit-any findings in typed request-list rows and mutation error paths. Request creation/cancellation and notification RPC paths were not invoked. Baseline is 825 explicit-any / 832 total errors / 39 warnings across 191 files; authenticated browser verification is pending.
