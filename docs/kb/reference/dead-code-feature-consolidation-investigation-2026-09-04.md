...
The immediately actionable first-wave potential is about **6,627 lines**, already above the parent plan's original 3,000–6,000 conservative target. That is a reason to split it into domain PRs, not to raise deletion scope automatically. **Update 2026-09-04:** the three retired cohorts above account for about 5,218 of those lines; the remaining first-wave candidates (legacy suggestion pages, orphaned document-version hook, unused landing-page alias) total about 1,409 lines.
