...
> **Status:** M0 inventory complete; M2/M3 retirement applied; M4 retirement staged 2026-09-08
>
> **Captured:** 2026-09-08
>
...
Production currently has 22 active cron jobs (27 before M2; jobs 14 and 15 are already absent). The M4 retirement migration will reduce this to 20 after it is applied. The current schedule is not uniformly
healthy:

- jobs 4, 5 and 6 were a legacy audit-reminder path and were unscheduled by M2;
- jobs 20 and 21 are approved for retirement and have a guarded migration
  staged; their forecast tables remain empty;
...
| 20 | `run-tenant-risk-forecast-nightly` | `0 13 * * *` | 30 | 0 | `tenant_risk_forecasts` has 0 rows; retirement migration staged | Retire by M4 (2026-09-08; pending apply) |
| 21 | `run-retention-forecast-nightly` | `0 14 * * *` | 30 | 0 | `tenant_retention_forecasts` has 0 rows; retirement migration staged | Retire by M4 (2026-09-08; pending apply) |
