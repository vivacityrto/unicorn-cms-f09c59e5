...
- Pass `req` from the Edge Function handler to `handleBrowse` and declare it in the helper signature.
- Add a Node regression test asserting that the browse helper retains request context for CORS responses.
