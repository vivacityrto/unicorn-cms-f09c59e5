...
> **Status (2026-05):** This document predates the EOS module's RLS consolidation. Some policy/helper details below have been superseded. See `docs/EOS_LEVEL10_SPECIFICATION.md` §5.2 (RLS Policies) and §5.2.1 (EOS Audit Ledger), and `CONTRIBUTING.md` → Database Conventions for current rules. Retained as historical reference.
