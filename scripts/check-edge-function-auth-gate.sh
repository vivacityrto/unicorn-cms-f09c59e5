...
AUTH_PATTERN='requireCaller\(|requireSharedSecret\(|requireInternalEmailSecret\(|requireSuperAdmin\(|isCronAuthorized\(|checkSuperAdmin\(|check_permission|auth\.getUser\(|auth\.getClaims\(|verifyAuth\(|MAILGUN_WEBHOOK_SIGNING_KEY|constantTimeEqual\(|verifyAddinToken\(|authorizeCronInvoke\('
