...
BEGIN
  ...
  -- Map unicorn_role -> tenant_users.role + primary_contact
  ...
  -- Determine user_type from tenant (Vivacity tenant 6372 -> Vivacity, else Client)
  ...
  INSERT INTO public.users (
    ...
    v_invitation.unicorn_role::public.unicorn_role_enum,
  ...
  -- INSERT into the ACTIVE tenant_users membership table
