CREATE OR REPLACE FUNCTION public.launch_cohort_job(p_action text, p_filter jsonb, p_cap integer DEFAULT 1000, p_batch_size integer DEFAULT 10, p_throttle_ms integer DEFAULT 400, p_notes text DEFAULT NULL::text, p_include_uuids uuid[] DEFAULT NULL::uuid[])
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
