-- Fix persist_tga_scope_items to allow service-role passthrough while keeping staff gate for authenticated users.
-- Mirrors the pattern applied to tga_swap_scope_from_staging, tga_start_staged_sync, upsert_excel_template_bindings, and stall_bulk_document_job.
