-- Update the admin_set_tenant_csc_assignment function to use staff_teams array
-- instead of the deprecated is_csc boolean field
...
BEGIN
  ...
  -- Check if user is a CSC - look at both staff_teams array AND legacy is_csc/staff_team fields
  ...
  -- User is eligible if:
  -- 1. They have 'client_success' in their staff_teams array, OR
  -- 2. Their staff_team is 'client_success', OR
  -- 3. The legacy is_csc flag is true
  IF NOT (
