-- =====================================================================
-- Migration: update_dashboard_views_skip_published_cti  (2 of 5)
-- Pre-deploy snapshot (run manually and save):
...
-- =====================================================================
-- Post-deploy: re-run the snapshot query and diff against pre-deploy.
-- Counts must match exactly (no CTI rows have published_action_item_id set yet).
-- =====================================================================