...
BEGIN
  ...
  EXCEPTION WHEN foreign_key_violation THEN
    RAISE WARNING 'set_relationship_role: audit_eos_events insert skipped for user % in tenant % — no auth.users row found (ghost user). tenant_users change was still applied.',
