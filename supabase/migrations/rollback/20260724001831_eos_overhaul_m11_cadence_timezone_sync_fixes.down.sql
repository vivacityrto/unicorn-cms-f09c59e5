-- ============================================================
-- Rollback for 20260724001831_eos_overhaul_m11_cadence_timezone_sync_fixes.sql
-- Restores auto_generate_next_meeting to its pre-M11 (M9) body,
-- and create_meeting_from_configuration / sync_meeting_to_configuration
-- to their pre-M11 (M10) bodies - has_permission check from M10 is
-- retained on the latter two since M10 is not being rolled back here.
-- ============================================================
