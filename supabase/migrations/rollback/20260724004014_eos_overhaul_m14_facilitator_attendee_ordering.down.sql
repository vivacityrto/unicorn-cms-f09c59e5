-- ============================================================
-- Rollback for 20260724004014_eos_overhaul_m14_facilitator_attendee_ordering.sql
-- Restores create_meeting_from_configuration and auto_generate_next_meeting
-- to their pre-M14 (M11) bodies, removing the direct facilitator
-- attendee upsert.
-- ============================================================
