-- ============================================================
-- Rollback for 20260724013655_eos_overhaul_m17_validate_close_ratings_formula.sql
-- Restores validate_meeting_close's required-ratings formula to
-- GREATEST(1, FLOOR(present * 0.5)), its pre-M17 (pre-existing, never
-- touched by this branch until now) body.
-- ============================================================
