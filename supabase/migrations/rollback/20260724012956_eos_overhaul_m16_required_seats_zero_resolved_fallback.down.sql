-- ============================================================
-- Rollback for 20260724012956_eos_overhaul_m16_required_seats_zero_resolved_fallback.sql
-- Restores seed_meeting_attendees and sync_meeting_to_configuration to
-- their pre-M16 (M15) bodies, removing the zero-resolved-holder fallback
-- check and reverting to the array-emptiness-only guard.
-- ============================================================
