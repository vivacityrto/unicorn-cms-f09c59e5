...
import {
  FileText, Save, Send, Loader2, CheckCircle2, Plus, Trash2, Download, RefreshCw,
} from 'lucide-react';
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will generate a Vivacity-branded document and make it available in the client portal. The client will be able to view and download these minutes.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will create a new version (v{(minutes.version || 1) + 1}) and update the document in the client portal. The previous version will be retained internally.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
