...
interface AddStaffTaskDialogProps {
  open: boolean;
...
export function AddStaffTaskDialog({ open, onOpenChange, onSuccess, packageId, stageId, editTask }: AddStaffTaskDialogProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editTask) {
        ...
        toast({
          title: "Success",
          description: "Staff task updated successfully"
        });
      } else {
        // Insert new task
        const { error } = await supabase
        ...
        toast({
          title: "Success",
          description: "Staff task created successfully"
        });
      }
        ...
        >
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              {editTask ? 'Edit' : 'Create'} Staff Task
            </DialogTitle>
          </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              The date this task should become due
            </p>
          </div>
        </div>
