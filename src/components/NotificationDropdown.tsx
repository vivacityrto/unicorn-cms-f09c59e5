      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 h-5 min-w-[20px] px-1 bg-destructive rounded-full flex items-center justify-center text-destructive-foreground text-xs font-bold">
