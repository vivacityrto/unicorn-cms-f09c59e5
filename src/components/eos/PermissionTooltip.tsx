...
const PERMISSION_REQUIRED_ROLES: Record<Permission, string> = {
  ...
  'vto:edit': 'Admin, Team Leader, or Team Member',
  'eos_meetings:schedule': 'Admin or Team Leader',
  'eos_meetings:edit': 'Admin or Team Leader',
  'qc:schedule': 'Admin or Team Leader',
  'qc:edit': 'Admin or Team Leader',
  'qc:view_all': 'Admin or Team Leader',
  'qc:sign': 'All roles',
  'rocks:create': 'All roles',
  'rocks:edit_own': 'All roles',
  'rocks:edit_others': 'Admin or Team Leader',
  'risks:create': 'All roles',
  'risks:escalate': 'Admin or Team Leader',
  'risks:close_critical': 'Super Admin only',
  'agenda_templates:manage': 'Admin or Super Admin',
};
