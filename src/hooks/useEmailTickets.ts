...
const SELECT_COLS =
  "id, ticket_number, sender_name, sender_email, tenant_id, category, urgent, subject, body_preview, original_email_id, triage_status, triaged_by, triaged_at, assigned_to_user_id, assigned_at, status, response_due_at, sla_breached, received_at, created_at, updated_at";
