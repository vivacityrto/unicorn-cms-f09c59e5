  ...
  return (
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        >
          {/* Thread list */}
          <div className="2xl:col-span-1 min-w-0 border rounded-lg overflow-hidden border-border">
            {filtered.length === 0 ? (
          ...
          <div className="2xl:col-span-2 min-w-0 border rounded-lg border-border flex flex-col">
            {selected ? (
              <>
