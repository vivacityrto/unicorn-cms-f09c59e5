...
const ACCENT = "#7130A0";
const AUDIENCE_KEY = "administration_assistant";

const categoryTabs = ["All", "Strategic Planning", "Branding & Marketing", "Business Operations", "Governance"];
...
export default function AdministrationAssistantPage() {
  ...
  return (
    <AcademyPageWrapper
      ...
      subtitle="Strategic planning, branding, business operations, and governance essentials"
        ...
        {categoryTabs.map((cat) => (
          <button
            ...
            className={cn(
              ...
              activeFilter === cat
                ? "text-[#7130A0] border-b-2 border-[#7130A0]"
